...
public class ResponseAdvice implements ResponseBodyAdvice<Object> {
    ...
    public Object beforeBodyWrite(Object body, MethodParameter returnType, MediaType selectedContentType, Class<? extends HttpMessageConverter<?>> selectedConverterType, ServerHttpRequest request, ServerHttpResponse response) {
        ...
        if (Objects.nonNull(body) && body instanceof R) {
            ...
            Object data = ((R<?>) body).getData();// (R<?>) body --> 强转成统一结果集
            // 响应结果中的data不为空
    ...
    private void findEncryptedPropertyRequired(Object data) throws IllegalAccessException {
        ...
        // 已经不是集合了，现在是对象，获取对象中的属性，并且判断是否有注解
            ...
            // 循环遍历所有属性, 判断是否有指定注解
            //hasChildrenFieldHandler(List.of(declaredFields), data); //jdk9可以使用
            hasChildrenFieldHandler(Arrays.asList(declaredFields), data);
        }
    }
    ...
    private void hasChildrenFieldHandler(List<Field> fields, Object obj) throws IllegalAccessException {
        for (Field field : fields) {
            ...
            // 获取字段的所有属性值
            //List<Field> innerFields = List.of(o.getClass().getDeclaredFields()); //jdk9可以使用
            List<Field> innerFields = Arrays.asList(o.getClass().getDeclaredFields());
            // 如果是集合还得继续往下找
